#!/system/bin/sh
if ! applypatch --check EMMC:/dev/block/bootdevice/by-name/recovery:38441488:d7589df1118085a39d9951d43fe8948842a1a36e; then
  applypatch \
          --patch /system/recovery-from-boot.p \
          --source EMMC:/dev/block/bootdevice/by-name/boot:27202064:f2ab0599ff84d3622c160f89d5a65b2c544be8d3 \
          --target EMMC:/dev/block/bootdevice/by-name/recovery:38441488:d7589df1118085a39d9951d43fe8948842a1a36e && \
