#!/system/bin/sh
if ! applypatch --check EMMC:/dev/block/bootdevice/by-name/recovery:38437392:969afecd9d837187c9b5834b513e1da2861956f0; then
  applypatch \
          --patch /system/recovery-from-boot.p \
          --source EMMC:/dev/block/bootdevice/by-name/boot:27197968:c5e87d41bb291dbfed8c4f578e9bf562eec20684 \
          --target EMMC:/dev/block/bootdevice/by-name/recovery:38437392:969afecd9d837187c9b5834b513e1da2861956f0 && \
